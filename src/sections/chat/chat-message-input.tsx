...
import { useChatMutations } from 'src/actions/chat';
...
export function ChatMessageInput({
  ...
  const { sendMessage, createConversation } = useChatMutations();
    ...
    async (event: React.KeyboardEvent<HTMLInputElement>) => {
      ...
      try {
        if (selectedConversationId) {
          ...
          await sendMessage({ conversationId: selectedConversationId, messageData });
        } else {
