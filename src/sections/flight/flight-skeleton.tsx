...
type FlightItemSkeletonProps = PaperProps & {
  itemCount?: number;
};

export function FlightItemSkeleton({ sx, itemCount = 16, ...other }: FlightItemSkeletonProps) {
...
export function FlightDetailsSkeleton({ ...other }: Grid2Props) {
  return (
